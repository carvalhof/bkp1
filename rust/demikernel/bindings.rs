...
#[allow(unused)]
#[no_mangle]
pub extern "C" fn demi_init(argc: c_int, _argv: *mut *mut c_char) -> c_int {
    logging::initialize();
    trace!("demi_init()");
...
#[no_mangle]
pub extern "C" fn demi_push(_qtok_out: *mut demi_qtoken_t, _qd: c_int, _sga: *const demi_sgarray_t) -> c_int {
    trace!("demi_push()");
