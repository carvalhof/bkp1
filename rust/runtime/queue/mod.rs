...
use super::network::consts::RECEIVE_BATCH_SIZE;
...
pub type Operation = dyn Future<Output = (*mut ControlBlock<RECEIVE_BATCH_SIZE>, OperationResult)>;
// Task for running I/O operations
pub type OperationTask = TaskWithResult<(*mut ControlBlock<RECEIVE_BATCH_SIZE>, OperationResult)>;
